  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-r from-blue-50/50 via-transparent to-indigo-50/50 rounded-full blur-3xl opacity-40" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              {[
                { icon: Mail, label: 'Email', value: 'hello@estateai.com', href: 'mailto:hello@estateai.com' },
