...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-[var(--color-primary-50)] text-[var(--color-primary-900)] overflow-x-hidden">
      ...
      {/* Navigation */}
      <nav className="relative z-50 border-b border-[var(--color-primary-200)] backdrop-blur-md bg-white/80">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-[var(--color-primary-900)]">
              AgentFlow
            </span>
          </div>
          <div className="hidden md:flex items-center gap-8">
            <a href="#" className="text-sm text-[var(--color-primary-700)] hover:text-[var(--color-primary-900)] transition-colors">Platform</a>
            <a href="#" className="text-sm text-[var(--color-primary-700)] hover:text-[var(--color-primary-900)] transition-colors">Agents</a>
            <a href="#" className="text-sm text-[var(--color-primary-700)] hover:text-[var(--color-primary-900)] transition-colors">Pricing</a>
            <button className="px-5 py-2.5 rounded-full bg-[var(--color-primary-600)] hover:bg-[var(--color-primary-700)] text-white text-sm font-medium transition-all">
              Sign In
            </button>
          </div>
        </div>
