...
const TESTIMONIALS: Testimonial[] = [
  {
    id: 1,
    quote:
      "The Lease Analyzer agent flagged three non-standard clauses in our portfolio review that our legal team missed. It paid for itself in the first week.",
    name: "Sarah Chen",
  ...
  },
  {
    id: 2,
    quote:
      "Our maintenance costs dropped 31% in Q1 after deploying the Predictive Maintenance agent. The AI flagged our boiler issue two weeks before it would have failed.",
    name: "James Okafor",
    ...
    rating: 5,
    agentUsed: "Maintenance Predictor",
    metric: "−31%",
    metricLabel: "Maintenance costs",
  },
  {
    id: 3,
    quote:
      "Tenant screening used to take us two days. The AI does it in four minutes with a cleaner risk breakdown than we ever produced manually.",
    name: "Priya Ramanujan",
    role: "Leasing Manager",
    company: "Ashford Urban Living",
    location: "Austin, TX",
    image: "https://i.pravatar.cc/96?img=25",
    rating: 5,
    agentUsed: "Tenant Screener",
    metric: "4 min",
    metricLabel: "Avg. screening time",
  },
  {
    id: 4,
    quote:
      "The Market Valuation agent catches rent pricing gaps I'd never have spotted manually. We increased portfolio revenue by 12% in six months.",
    name: "Marcus Webb",
  ...
  },
  {
    id: 5,
    quote:
      "Rent collection used to eat two hours of admin every Monday morning. The Payment Tracker agent handles follow-ups automatically and our arrears rate hit zero.",
    name: "Fatima Al-Hassan",
    role: "Operations Lead",
    company: "Crescent Block Management",
    location: "Dubai, UAE",
    image: "https://i.pravatar.cc/96?img=56",
    rating: 5,
    agentUsed: "Payment Tracker",
    metric: "0%",
    metricLabel: "Arrears rate",
  },
  {
    id: 6,
    quote:
      "Tenants now get instant replies at 2 AM when something breaks. The Comms Agent handles 90% of messages without any human input — and tenants love it.",
    name: "David Linares",
    role: "CEO",
    company: "CasaFlow Management",
    location: "Miami, FL",
    image: "https://i.pravatar.cc/96?img=8",
    rating: 5,
    agentUsed: "Comms Agent",
    metric: "90%",
    metricLabel: "Auto-resolved tickets",
  },
];
...
const TICKER_LINES: string[] = [
  "Verified result · Lease Analyzer · San Francisco",
  "Verified result · Maintenance Predictor · Chicago",
  "Verified result · Tenant Screener · Austin",
  "Verified result · Market Valuation · New York",
];
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px", position: "relative", zIndex: 2 }}>
          ...
          <div style={{ textAlign: "center", maxWidth: 600, margin: "0 auto 20px" }}>
            ...
            <p style={{ fontSize: 15, color: C.textBody, lineHeight: 1.65, fontFamily: "system-ui, sans-serif" }}>
              Real results from real portfolios. Every metric below was reported
              directly by clients after deploying EstateAI agents.
            </p>
          </div>
